...
import (
	...
	"github.com/lightzapp/lightz-client/internal/cln"
	"github.com/lightzapp/lightz-client/internal/database"
	"github.com/lightzapp/lightz-client/internal/lnd"
...
func LoadConfig(dataDir string) (*Config, error) {
	...
	cfg.ConfigFile = utils.ExpandDefaultPath(cfg.DataDir, cfg.ConfigFile, "lightz.toml")
	...
	cfg.LogFile = utils.ExpandDefaultPath(cfg.DataDir, cfg.LogFile, "lightz.log")
	...
	cfg.Database.Path = utils.ExpandDefaultPath(cfg.DataDir, cfg.Database.Path, "lightz.db")
