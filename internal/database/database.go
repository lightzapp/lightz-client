...
var FailedSwapQuery = SwapQuery{
	States: []lightzrpc.SwapState{lightzrpc.SwapState_ERROR, lightzrpc.SwapState_SERVER_ERROR, lightzrpc.SwapState_REFUNDED},
}
...
func (query *SwapQuery) ToWhereClauseWithExisting(conditions []string, values []any) (string, []any) {
	...
	if query.Include == lightzrpc.IncludeSwaps_MANUAL {
		conditions = append(conditions, "isAuto = ?")
		values = append(values, false)
	}
	if query.Include == lightzrpc.IncludeSwaps_AUTO {
		conditions = append(conditions, "isAuto = ?")
