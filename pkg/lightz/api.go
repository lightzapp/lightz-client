...
func (lightz *Api) GetVersion() (*GetVersionResponse, error) {
	var response GetVersionResponse
	err := lightz.sendGetRequestV2("/version", &response)

	return &response, err
}

// Deprecated: use GetSubmarinePairs, GetChainPairs or GetReversePairs instead
func (lightz *Api) GetPairs() (*GetPairsResponse, error) {
	var response GetPairsResponse
	err := lightz.sendGetRequest("/getpairs", &response)

	return &response, err
}

func (lightz *Api) GetFeeEstimation(currency Currency) (float64, error) {
	var response struct {
		Fee float64
	}
	err := lightz.sendGetRequestV2(fmt.Sprintf("/chain/%s/fee", currency), &response)

	return response.Fee, err
}

func (lightz *Api) GetSubmarinePairs() (response SubmarinePairs, err error) {
	err = lightz.sendGetRequestV2("/swap/submarine", &response)

	return response, err
}

func (lightz *Api) GetReversePairs() (response ReversePairs, err error) {
	err = lightz.sendGetRequestV2("/swap/reverse", &response)

	return response, err
}

func (lightz *Api) GetChainPairs() (response ChainPairs, err error) {
	err = lightz.sendGetRequestV2("/swap/chain", &response)

	return response, err
}

func (lightz *Api) GetNodes() (Nodes, error) {
	var response Nodes
	err := lightz.sendGetRequestV2("/nodes", &response)

	return response, err
}

func (lightz *Api) SwapStatus(id string) (*SwapStatusResponse, error) {
	var response SwapStatusResponse
	err := lightz.sendGetRequestV2("/swap/"+id, &response)
...
func (lightz *Api) GetSwapTransaction(id string) (*GetSwapTransactionResponse, error) {
	var response GetSwapTransactionResponse
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/submarine/%s/transaction", id), &response)
...
func (lightz *Api) GetSwapPreimage(id string) (HexString, error) {
	var response struct {
		Preimage HexString `json:"preimage"`
	}
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/submarine/%s/preimage", id), &response)

	return response.Preimage, err
}

func (lightz *Api) GetChainSwapTransactions(id string) (*GetChainSwapTransactionsResponse, error) {
	var response GetChainSwapTransactionsResponse
	path := fmt.Sprintf("/swap/chain/%s/transactions", id)
	err := lightz.sendGetRequestV2(path, &response)
...
func (lightz *Api) GetTransactionDetails(transactionId string, currency Currency) (*GetTransactionResponse, error) {
...
func (lightz *Api) GetTransaction(transactionId string, currency Currency) (string, error) {
	response, err := lightz.GetTransactionDetails(transactionId, currency)
	if err != nil {
		return "", err
	}
...
func (lightz *Api) EstimateFee(currency Currency) (float64, error) {
	var response struct {
		Fee float64
	}
	err := lightz.sendGetRequestV2(fmt.Sprintf("/chain/%s/fee", currency), &response)
...
func (lightz *Api) GetBlockHeight(currency Currency) (uint32, error) {
	var response struct {
		Height uint32
	}
	err := lightz.sendGetRequestV2(fmt.Sprintf("/chain/%s/height", currency), &response)

	return response.Height, err
}

func (lightz *Api) BroadcastTransaction(currency Currency, txHex string) (string, error) {
	var response BroadcastTransactionResponse
	err := lightz.sendPostRequest(fmt.Sprintf("/chain/%s/transaction", currency), BroadcastTransactionRequest{
		Hex: txHex,
	}, &response)
...
func (lightz *Api) CreateSwap(request CreateSwapRequest) (*CreateSwapResponse, error) {
	var response CreateSwapResponse
	err := lightz.sendPostRequest("/swap/submarine", request, &response)
...
func (lightz *Api) RefundSwap(swapId string, request *RefundRequest) (*PartialSignature, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response PartialSignature
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/submarine/%s/refund", swapId), request, &response)
...
func (lightz *Api) GetInvoiceAmount(swapId string) (*GetInvoiceAmountResponse, error) {
	var response GetInvoiceAmountResponse
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/submarine/%s/invoice/amount", swapId), &response)
...
func (lightz *Api) GetSwapClaimDetails(swapId string) (*SwapClaimDetails, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response SwapClaimDetails
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/submarine/%s/claim", swapId), &response)
...
func (lightz *Api) SendSwapClaimSignature(swapId string, signature *PartialSignature) error {
	var response ErrorMessage
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/submarine/%s/claim", swapId), signature, &response)
...
func (lightz *Api) SetInvoice(swapId string, invoice string) (*SetInvoiceResponse, error) {
	var response SetInvoiceResponse
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/submarine/%s/invoice", swapId), SetInvoiceRequest{Invoice: invoice}, &response)
...
func (lightz *Api) CreateReverseSwap(request CreateReverseSwapRequest) (*CreateReverseSwapResponse, error) {
	var response CreateReverseSwapResponse
	err := lightz.sendPostRequest("/swap/reverse", request, &response)
...
func (lightz *Api) ClaimReverseSwap(swapId string, request *ClaimRequest) (*PartialSignature, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response PartialSignature
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/reverse/%s/claim", swapId), request, &response)
...
func (lightz *Api) CreateChainSwap(request ChainRequest) (*ChainResponse, error) {
	var response ChainResponse
	err := lightz.sendPostRequest("/swap/chain", request, &response)
...
func (lightz *Api) GetChainSwapClaimDetails(swapId string) (*ChainSwapSigningDetails, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response ChainSwapSigningDetails
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/chain/%s/claim", swapId), &response)
...
func (lightz *Api) ExchangeChainSwapClaimSignature(swapId string, request *ChainSwapSigningRequest) (*PartialSignature, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response PartialSignature
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/chain/%s/claim", swapId), request, &response)
...
func (lightz *Api) RefundChainSwap(swapId string, request *RefundRequest) (*PartialSignature, error) {
	if lightz.DisablePartialSignatures {
		return nil, ErrPartialSignaturesDisabled
	}
	var response PartialSignature
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/chain/%s/refund", swapId), request, &response)
...
func (lightz *Api) GetReverseSwapBip21(invoice string) (*ReverseBip21, error) {
	var response ReverseBip21
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/reverse/%s/bip21", invoice), &response)
...
func (lightz *Api) GetChainSwapQuote(swapId string) (*Quote, error) {
	var response Quote
	err := lightz.sendGetRequestV2(fmt.Sprintf("/swap/chain/%s/quote", swapId), &response)
...
func (lightz *Api) AcceptChainSwapQuote(swapId string, quote *Quote) error {
	var response ResponseError
	err := lightz.sendPostRequest(fmt.Sprintf("/swap/chain/%s/quote", swapId), quote, &response)

	return response.ApiError(err)
}

func (lightz *Api) FetchBolt12Invoice(offer string, amountSat uint64) (string, error) {
	var response struct {
		Invoice string `json:"invoice"`
	}
	request := struct {
	...
	err := lightz.sendPostRequest("/lightning/BTC/bolt12/fetch", &request, &response)

	return response.Invoice, err
}

func (lightz *Api) sendGetRequest(endpoint string, response interface{}) error {
	request, err := http.NewRequest("GET", lightz.URL+endpoint, nil)
	if err != nil {
		return err
	}
	request.Header.Set("Referral", lightz.Referral)

	res, err := lightz.Client.Do(request)
...
func (lightz *Api) sendGetRequestV2(endpoint string, response interface{}) error {
	return lightz.sendGetRequest("/v2"+endpoint, response)
}

func (lightz *Api) sendPostRequest(endpoint string, requestBody interface{}, response interface{}) error {
	...
	res, err := lightz.Client.Post(lightz.URL+"/v2"+endpoint, "application/json", bytes.NewBuffer(rawBody))
	...
	if err := unmarshalJson(res.Body, &response); err != nil {
		return fmt.Errorf("could not parse lightzd response with status %d: %v", res.StatusCode, err)
	}
	return nil
}
