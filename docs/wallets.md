...
`lightzd-client` allows you to manage Bitcoin and [Liquid](https://liquid.net/)
...
`lightzcli wallet create MyLiquidWallet LBTC`
...
`lightzcli wallet import cold BTC`

A list of available wallets can be generated using `lightzcli wallet list`. The
